...
export class CustomerController {
  constructor(private readonly service: CustomerService, private readonly sequelize: Sequelize) {}
  @ApiOperation({ summary: '创建' })
  @HttpCode(HttpStatus.OK)
  @Post('/')
  async create(@Body() dto: CCustomerDto, @Req() req) {
  ...
  @Put(':id')
  async edit(@Body() dto: UCustomerDto, @Param() params, @Req() req) {
    let { factoryCode, loadModel } = req
    const { id } = params
