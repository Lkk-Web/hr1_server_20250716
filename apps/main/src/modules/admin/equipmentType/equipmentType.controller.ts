...
@ApiTags('设备类型')
@ApiBearerAuth()
@AdminAuth('equipmentType')
export class EquipmentTypeController {
  constructor(private readonly service: EquipmentTypeService, private readonly sequelize: Sequelize) {}
  @ApiOperation({ summary: '创建' })
  @HttpCode(HttpStatus.OK)
  @Post('/')
  async create(@Body() dto: CEquipmentTypeDTO, @Req() req) {
  ...
  @Put(':id')
  async edit(@Body() dto: UEquipmentTypeDTO, @Param() params, @Req() req) {
    let { factoryCode, loadModel } = req
    const { id } = params
