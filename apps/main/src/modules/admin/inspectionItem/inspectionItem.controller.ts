...
@ApiTags('检验项次')
@ApiBearerAuth()
@AdminAuth('inspectionItem')
export class InspectionItemController {
  constructor(private readonly service: InspectionItemService, private readonly sequelize: Sequelize) {}
  @ApiOperation({ summary: '创建' })
  @HttpCode(HttpStatus.OK)
  @Post('/')
  async create(@Body() dto: CInspectionItemDTO, @Req() req) {
  ...
  @Put(':id')
  async edit(@Body() dto: UInspectionItemDTO, @Param() params, @Req() req) {
    let { factoryCode, loadModel } = req
    const { id } = params
