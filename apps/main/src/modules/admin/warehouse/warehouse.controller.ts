...
export class WarehouseController {
  constructor(private readonly service: WarehouseService, private readonly sequelize: Sequelize) {}
  @ApiOperation({ summary: '创建' })
  @HttpCode(HttpStatus.OK)
  @Post('/')
  async create(@Body() dto: CWarehouseDto, @Req() req) {
  ...
  @Put(':id')
  async edit(@Body() dto: UWarehouseDto, @Param() params, @Req() req) {
    let { factoryCode, loadModel } = req
    const { id } = params
