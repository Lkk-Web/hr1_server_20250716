...
export class SupplierController {
  constructor(private readonly service: SupplierService, private readonly sequelize: Sequelize) {}
  @ApiOperation({ summary: '创建' })
  @HttpCode(HttpStatus.OK)
  @Post('/')
  async create(@Body() dto: CSupplierDto, @Req() req) {
  ...
  @Put(':id')
  async edit(@Body() dto: USupplierDto, @Param() params, @Req() req) {
    let { factoryCode, loadModel } = req
    const { id } = params
