...
@ApiTags('工序任务单')
@ApiBearerAuth()
@AdminAuth('processTask')
export class ProcessTaskController {
  constructor(private readonly service: ProcessTaskService, private readonly sequelize: Sequelize) {}
  @ApiOperation({ summary: '创建' })
  @HttpCode(HttpStatus.OK)
  @Post('/')
  async create(@Body() dto: CProcessTaskDto, @Req() req) {
  ...
  @Put(':id')
  async edit(@Body() dto: UProcessTaskDto, @Param() params, @Req() req) {
    let { factoryCode, loadModel } = req
    const { id } = params
