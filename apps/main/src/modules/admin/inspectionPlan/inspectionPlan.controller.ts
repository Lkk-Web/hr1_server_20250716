...
@ApiTags('巡检方案')
@ApiBearerAuth()
@AdminAuth('inspectionPlan')
export class InspectionPlanController {
  constructor(private readonly service: InspectionPlanService, private readonly sequelize: Sequelize) {}
  @ApiOperation({ summary: '创建' })
  @HttpCode(HttpStatus.OK)
  @Post('/')
  async create(@Body() dto: CInspectionPlanDTO, @Req() req) {
  ...
  @Put(':id')
  async edit(@Body() dto: UInspectionPlanDTO, @Param() params, @Req() req) {
    let { factoryCode, loadModel } = req
    const { id } = params
