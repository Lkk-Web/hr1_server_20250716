...
@ApiTags('打印模版')
@ApiBearerAuth()
@AdminAuth('printTemplate')
export class PrintTemplateController {
  constructor(private readonly service: PrintTemplateService, private readonly sequelize: Sequelize) {}
  @ApiOperation({ summary: '创建' })
  @HttpCode(HttpStatus.OK)
  @Post('/')
  async create(@Body() dto: CPrintTemplateDto, @Req() req) {
  ...
  @Put(':id')
  async edit(@Body() dto: UPrintTemplateDto, @Param() params, @Req() req) {
    let { factoryCode, loadModel } = req
    const { id } = params
