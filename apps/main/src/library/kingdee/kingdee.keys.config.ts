...
export const K3Mapping = {
  ...
  BD_MATERIAL: {
    ...
    keys: [
      ...
      ['物料分组', 'FMaterialGroup.FName', 'category'],
      ['名称', 'FName', 'name'],
      ['规格型号', 'FSpecification', 'spec'],
      ['图号', 'F_ora_Text', 'k3DrawingNo'],
      ['国标图号', 'F_ora_Text3', 'k3StandardDrawingNo'],
      ['基本单位', 'FBaseUnitId.FName', 'unit'],
      ['描述', 'FDescription', 'remark'],
      ['材质', 'F_ora_Text2', 'k3Meterial'],
      ['辅助单位', 'FAuxUnitID.FName', 'k3AuxUinit'],
      ['颜色', 'F_ora_Text1', 'k3Color'],
      ['单件重量', 'F_ora_Decimal', 'unitWeight'],
      ['重量单位', 'FWEIGHTUNITID.FNumber', 'unitsWeight'],
